    ...
    <section className="bg-[#E0E4EC]">
        ...
        <div className="pl-5 py-10 grid grid-cols-[1fr_1.5fr] gap-5">
            {/* Grid Text */}
             ...
             {/* Gird Image */}
            <article>
                <img src={IMG1} alt="A woman receiving treatment" className='h-[38rem] w-[51rem] bg-transparent'/>
            </article>
        </div>

        <div>
            <p className='text-center text-[#08299B] font-bold'>Find a nearby hospital</p>
            <div className="w-1/2 mx-auto mt-1 mb-5 block ">
                ...
                <AiOutlineSearch color="#000" class="-translate-y-7 translate-x-[39rem]"/>
            </div>
        </div>
    </section>
  )
